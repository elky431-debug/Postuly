    ...
    <div className="space-y-4">
      <div className="grid gap-3 lg:grid-cols-[1fr_1fr_minmax(200px,240px)_auto] lg:items-end">
        <label className="block">
          <span className="mb-1.5 flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-wide text-neutral-500">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-neutral-200 bg-white py-2.5 pl-10 pr-3 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-[#F97316] focus:outline-none focus:ring-2 focus:ring-[#F97316]/25"
            />
          </div>
        </label>
        <label className="block">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between text-[11px] font-medium uppercase tracking-wide text-neutral-500">
            <span>Rayon</span>
          ...
          >
            ...
            <Slider.Thumb
              className={cn(
                "block h-4 w-4 rounded-full border-2 border-[#F97316] bg-white",
